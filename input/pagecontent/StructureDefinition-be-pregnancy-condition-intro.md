...
- **Pregnancy status** — a point-in-time clinical finding for *administrative sharing*, represented as an `Observation` aligned with the IPS *Pregnancy status* observation.
